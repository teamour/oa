...
--
-- Table structure for table `t_interviewer_resume`
--
...
--
-- Dumping data for table `t_interviewer_resume`
--

LOCK TABLES `t_interviewer_resume` WRITE;
/*!40000 ALTER TABLE `t_interviewer_resume` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_interviewer_resume` ENABLE KEYS */;
UNLOCK TABLES;
