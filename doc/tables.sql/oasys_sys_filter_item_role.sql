...
--
-- Table structure for table `sys_filter_item_role`
--
...
--
-- Dumping data for table `sys_filter_item_role`
--

LOCK TABLES `sys_filter_item_role` WRITE;
/*!40000 ALTER TABLE `sys_filter_item_role` DISABLE KEYS */;
/*!40000 ALTER TABLE `sys_filter_item_role` ENABLE KEYS */;
UNLOCK TABLES;
