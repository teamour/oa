...
--
-- Table structure for table `log_login_record`
--
...
--
-- Dumping data for table `log_login_record`
--

LOCK TABLES `log_login_record` WRITE;
/*!40000 ALTER TABLE `log_login_record` DISABLE KEYS */;
/*!40000 ALTER TABLE `log_login_record` ENABLE KEYS */;
UNLOCK TABLES;
