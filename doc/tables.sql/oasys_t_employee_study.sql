...
--
-- Table structure for table `t_employee_study`
--
...
--
-- Dumping data for table `t_employee_study`
--

LOCK TABLES `t_employee_study` WRITE;
/*!40000 ALTER TABLE `t_employee_study` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_employee_study` ENABLE KEYS */;
UNLOCK TABLES;
