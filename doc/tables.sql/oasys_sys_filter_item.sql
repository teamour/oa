...
--
-- Table structure for table `sys_filter_item`
--
...
--
-- Dumping data for table `sys_filter_item`
--

LOCK TABLES `sys_filter_item` WRITE;
/*!40000 ALTER TABLE `sys_filter_item` DISABLE KEYS */;
/*!40000 ALTER TABLE `sys_filter_item` ENABLE KEYS */;
UNLOCK TABLES;
