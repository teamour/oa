		...
		if(!sendEmailInit){
			...
			$("#mailCustomer").jqGrid({
				 	 ...
				 	 colModel: [
		                ...
		                { label: 'customerName', name: 'customerName', width: 70 },
		                ...
		                { label: 'proposal3Handler', name: 'proposal3Handler', width: 80 }
//				 		{ label: 'customerId', name: 'customerId', key: true,hidden:true},
//		                { label: 'customerName', name: 'customerName'},
//		                { label: 'salesEmail', name: 'salesEmail'},
//		                { label: 'salesStaff', name: 'salesStaff'},
//		                { label: 'proposal1Email', name: 'proposal1Email'},
//		                { label: 'proposal1Handler', name: 'proposal1Handler'},
//		                { label: 'proposal2Email', name: 'proposal2Email'},
//		                { label: 'proposal2Handler', name: 'proposal2Handler' },
//		                { label: 'proposal3Email', name: 'proposal3Email'},
//		                { label: 'proposal3Handler', name: 'proposal3Handler'}
	            ],
	            width: "100%",
	            height: "100%",
	            'loadError' : function (xhr, status, error){
